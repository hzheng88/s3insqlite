...
*This project is intended for testing or lightweight local storage use cases. It is not a replacement for production S3 services. The project is currently under development, with the goal of achieving compatibility with Zarr.*
